...
(async () => {
  ...
  prompt.get(schema, (err, result) => {
    ...
    const filesToRelocate = [
      ...
      [path.resolve(__dirname, '../lib/core/PDFInfoVersion1.chunk.js'), `${resourceDir}/lib/core/`, true],
      [path.resolve(__dirname, '../lib/core/SelectionInfoOld.chunk.js'), `${resourceDir}/lib/core/`, true],
      [path.resolve(__dirname, '../lib/core/pako.chunk.js'), `${resourceDir}/lib/core/`, true],
      [path.resolve(__dirname, '../lib/core/pikaday.chunk.js'), `${resourceDir}/lib/core/`, true],
      [path.resolve(__dirname, '../lib/core/vendors~ascii85.chunk.js'), `${resourceDir}/lib/core/`, true],
      [path.resolve(__dirname, '../lib/core/vendors~ascii85~quill.chunk.js'), `${resourceDir}/lib/core/`, true],
      [path.resolve(__dirname, '../lib/core/vendors~pako.chunk.js'), `${resourceDir}/lib/core/`, true],
      [path.resolve(__dirname, '../lib/core/vendors~quill.chunk.js'), `${resourceDir}/lib/core/`, true],
